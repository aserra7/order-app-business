...
const Comanda = ({ selectedComanda }) => {
    ...
    return (
        <div>
            <Container fluid='lg' className='d-flex flex-column' style={{ position: 'relative', height: 'calc(80vh - 7rem)' }}>
                ...
                <Row className='d-flex justify-content-between align-items-baseline mx-2 mt-2 px-1 border-bottom'>
                ...
                <div className='flex-grow-1 mt-0' style={{ overflowY: 'auto' }}>
                    <div>
                        {prod.map(item => (
